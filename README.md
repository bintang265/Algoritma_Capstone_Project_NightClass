...
This is Capstone Project at Algoritma Academy in Data Analytics Specialization with Python. The task is to do simple webscrapping to get information about extract the relevant information in web about the exchange rate IDR USD and visualize it. 
